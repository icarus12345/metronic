            ...
            <div class="white-box">
                ...
                <div class="product-detail">
                    ...
                    <div class="col-sm-8">
                        ...
                        <a href="JavaScript:"><button onclick="dialog('order-dialog');document.getElementById('order_cake_name').value='[{$product->product_title|escape:'html'}] - [{'thong-tin-banh/'|cat:$product->product_alias|base_url}]'" class="btn btn-danger">ĐẶT HÀNG</button></a>
