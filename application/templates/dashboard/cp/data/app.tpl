	    ...
	    this._columns = [
	        {
	            ...
	            text: 'Title', dataField: '[{$frefix}]title', width: 180, 
	            ...
	            text: 'Desc', dataField: '[{$frefix}]desc', minWidth: 220, 
	            sortable: true, editable: false, groupable:false,
	            columntype: 'textbox', filtertype: 'textbox', filtercondition: 'CONTAINS',
                validation: function (cell, value) {
                    if (value.length < 4 || value.length > 255) {
	            ...
	            text: 'Type', dataField: '[{$frefix}]datatype', width: 80, sortable: true,
	            editable: false,
	            columntype: 'textbox', filtertype: 'textbox', filtercondition: 'CONTAINS'
	        },{
