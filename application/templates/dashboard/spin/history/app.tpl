...
var APP = function() {
    ...
    this.bindingUri = '/dashboard/spin/history/databinding/';
    this.entryEditUri = '/dashboard/spin/history/editpanel/';
    this.entryCommitUri = '/dashboard/spin/history/oncommit/';
    this.entryDeleteUri = '/dashboard/spin/history/ondelete/';
    var me = this;
	    ...
	    this._columns = [
	        {
	            ...
	            text: 'Email', dataField: 'user_email', minWidth: 120, sortable: true,editable: false,
	            columntype: 'textbox', filtertype: 'textbox', filtercondition: 'CONTAINS'
	            
	        },{
	            text: 'Item', dataField: 'spin_name', minWidth: 120, sortable: true,editable: false,
	            columntype: 'textbox', filtertype: 'textbox', filtercondition: 'CONTAINS'
	            
	        },{
	            text: 'Code', dataField: '[{$frefix}]code', width: 80, sortable: true,editable: false,
	            columntype: 'textbox', filtertype: 'textbox', filtercondition: 'CONTAINS'
	        ...
	        try{
	            ...
	            switch (column) {
	                case '[{$frefix}]name':
	                    ...
	                    break;
                    case '[{$frefix}]number':
	                    if (_value != _data.[{$frefix}]number && _value!='')
	                        me.onCommit(
	                        	me.entryCommitUri,
	                        	{[{$frefix}]number: _value},
	                        	_id, updateCell
	                    	);
	                    break;
	                case '[{$frefix}]rate':
	                    if (_value != _data.[{$frefix}]rate && _value!='')
	                        me.onCommit(
	                        	me.entryCommitUri,
	                        	{[{$frefix}]rate: _value},
	                        	_id, updateCell
