...
var APP = function() {
    ...
    this.createGrid = function(){
    	this._datafields = [
	        ...
	        {name: '[{$frefix}]name' 	},
	        {name: '[{$frefix}]number' 	, type: 'int'},
	        {name: '[{$frefix}]active' 	, type: 'int'},
	        {name: '[{$frefix}]rate' , type: 'float'},
	        {name: '[{$frefix}]value' 	, type: 'int'},
	    ...
	    this._columns = [
	        {
	            ...
	            text: 'Title', dataField: '[{$frefix}]name', minWidth: 220, sortable: true,
	            ...
	            align: 'right', cellsalign: 'right',
          		validation: function (cell, value) {
                    if (value < 0 || value > 99) {
                        return { result: false, message: "Rate should be in the 0-99 interval" };
                    }
                    return true;
                },
                createeditor: function (row, cellvalue, editor) {
