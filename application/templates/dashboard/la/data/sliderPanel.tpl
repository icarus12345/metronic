                        ...
                        <div class="lang-controls">
                            [{foreach $aLang 'la'}]
                                <input 
                                    ...
                                    placeholder="Sub Title - [{$la->lang_name}]"
                                    name="data_data[subtitle][[{$la->lang_short}]]"
                                    data-prompt-position="topLeft:0,20"
                                    value="[{$item->data_data.subtitle[$la->lang_short]|escape:'html'|default:''}]"
                                    />  
                            [{/foreach}]
                        </div>
                    </div>
            ...
            <div class="pull-bottom control-group">
                ...
                <div class="">
                    <input type="text" 
                        class="form-control validate[required,maxSize[255]]"
                        data-prompt-position="topLeft:0,20"
                        value="[{$item->data_data.link|escape:'html'|default:''}]" 
                        name="data_data[link]"
                        >
                </div>
            </div> 
