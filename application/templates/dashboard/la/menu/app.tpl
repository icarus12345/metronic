...
var APP = function() {
    ...
    this.bindingUri = '/dashboard/la/menu/databinding/';
    this.entryEditUri = '/dashboard/la/menu/editpanel/';
    this.entryCommitUri = '/dashboard/la/menu/oncommit/';
    this.entryDeleteUri = '/dashboard/la/menu/ondelete/';
    var me = this;
