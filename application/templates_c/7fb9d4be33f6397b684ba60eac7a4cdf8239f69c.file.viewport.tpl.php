<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-07-17 14:54:17
         compiled from "application\templates\dashboard\la\category\viewport.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2687055a8b1479400a9-29181162%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7fb9d4be33f6397b684ba60eac7a4cdf8239f69c' => 
    array (
      0 => 'application\\templates\\dashboard\\la\\category\\viewport.tpl',
      1 => 1437119653,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2687055a8b1479400a9-29181162',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_55a8b147d2a353_73299801',
  'variables' => 
  array (
    'unit' => 0,
    'type' => 0,
...
<?php if ($_valid && !is_callable('content_55a8b147d2a353_73299801')) {function content_55a8b147d2a353_73299801($_smarty_tpl) {?>
...
>
                        <?php echo '<script'; ?>
 type="text/javascript" src="/dashboard/la/category/loadscript/app/<?php echo $_smarty_tpl->tpl_vars['unit']->value;?>
"><?php echo '</script'; ?>
>
                        <?php echo '<script'; ?>
...
';
                                ...
                                <?php }?>
                                myApp.isEntryDialog = <?php echo $_smarty_tpl->tpl_vars['action']->value['ispopup'];?>
;
                                myApp.onInit();
                            })
                        <?php echo '</script'; ?>
