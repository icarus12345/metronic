<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-06-28 10:19:44
         compiled from "application\templates\dashboard\layout\product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:31776558c21cd66eaf7-57947493%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '30e5805a54ed57ffdd3d19c0b7d4720aabc42574' => 
    array (
      0 => 'application\\templates\\dashboard\\layout\\product.tpl',
      1 => 1435461480,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '31776558c21cd66eaf7-57947493',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_558c21cd708946_62018011',
  'variables' => 
  array (
    'item' => 1,
    'type' => 1,
...
<?php if ($_valid && !is_callable('content_558c21cd708946_62018011')) {function content_558c21cd708946_62018011($_smarty_tpl) {?>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<?php echo $_smarty_tpl->getSubTemplate ((@constant('APPPATH')).("templates/dashboard/content/pageheader.tpl"), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
                            ...
                            <div class="col-mb-6 half"> 
                                <div class="control-group pull-top">
                                    ...
                                    <input type="text" 
                                        ...
                                        value="<?php echo (($tmp = @htmlspecialchars($_smarty_tpl->tpl_vars['item']->value->product_title, ENT_QUOTES, 'UTF-8', true))===null||$tmp==='' ? '' : $tmp);?>
" 
                                        name="product_title"
                                        maxlength="255" 
                                        >
                            ...
                            <div class="col-mb-6 half"> 
                                <div class="control-group pull-top">
                                    ...
                                    <input type="text" 
                                        ...
                                        class="form-control validate[required,minSize[4],maxSize[255]]"
                                        name="product_alias" 
                                        value="<?php echo (($tmp = @htmlspecialchars($_smarty_tpl->tpl_vars['item']->value->product_alias, ENT_QUOTES, 'UTF-8', true))===null||$tmp==='' ? '' : $tmp);?>
"/>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="control-group pull-top">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" 
                                                    ...
                                                    value="<?php echo (($tmp = @htmlspecialchars($_smarty_tpl->tpl_vars['item']->value->product_price, ENT_QUOTES, 'UTF-8', true))===null||$tmp==='' ? '' : $tmp);?>
" 
                                                    min="0"
                                                    name="product_price"
                        ...
                        <div class="control-group pull-top">
                            ...
                            <textarea 
                                ...
                                name="product_desc"><?php echo (($tmp = @htmlspecialchars($_smarty_tpl->tpl_vars['item']->value->product_desc, ENT_QUOTES, 'UTF-8', true))===null||$tmp==='' ? '' : $tmp);?>
</textarea>
                        ...
                        <?php } else { ?>
                            <div class="control-group pull-top">
                                ...
                                <textarea 
                                    ...
                                    class="form-control"
                                    id="product_content"
                                    name="product_content"><?php echo (($tmp = @htmlspecialchars($_smarty_tpl->tpl_vars['item']->value->product_content, ENT_QUOTES, 'UTF-8', true))===null||$tmp==='' ? '' : $tmp);?>
</textarea>
