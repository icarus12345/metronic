<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-07-08 19:18:01
         compiled from "application\templates\dashboard\cp\data\app.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19044559778f5dc3196-71352329%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8abac2bf4400a1721f7dcc7cdf1c62e31903a95a' => 
    array (
      0 => 'application\\templates\\dashboard\\cp\\data\\app.tpl',
      1 => 1436336052,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19044559778f5dc3196-71352329',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_559778f5eb8752_12794263',
  'variables' => 
  array (
    'catfrefix' => 0,
    'frefix' => 0,
...
<?php if ($_valid && !is_callable('content_559778f5eb8752_12794263')) {function content_559778f5eb8752_12794263($_smarty_tpl) {?><?php if (false) {?><?php echo '<script'; ?>
 type="text/javascript"><?php }?>
<?php if (isset($_smarty_tpl->tpl_vars['frefix'])) {$_smarty_tpl->tpl_vars['frefix'] = clone $_smarty_tpl->tpl_vars['frefix'];
$_smarty_tpl->tpl_vars['frefix']->value = 'data_'; $_smarty_tpl->tpl_vars['frefix']->nocache = null; $_smarty_tpl->tpl_vars['frefix']->scope = 0;
} else $_smarty_tpl->tpl_vars['frefix'] = new Smarty_variable('data_', null, 0);?>
...
var APP = function() {
    ...
    this.bindingUri 	= '/dashboard/cp/data/databinding/';
    this.catBindingUri 	= '/dashboard/cp/category/databinding/';
    this.entryEditUri 	= '/dashboard/cp/data/editpanel/';
    this.entryCommitUri = '/dashboard/cp/data/oncommit/';
    this.entryDeleteUri = '/dashboard/cp/data/ondelete/';
    var me = this;
...
update' , type: 'date'},
        ...
        this.cateApp._source = {
            ...
            url 		: me.catBindingUri+me.entryType,
...
title', width: 180, 
	            ...
	            text: 'Desc', dataField: '<?php echo $_smarty_tpl->tpl_vars['frefix']->value;?>
desc', minWidth: 220, 
	            sortable: true, editable: false, groupable:false,
	            columntype: 'textbox', filtertype: 'textbox', filtercondition: 'CONTAINS',
                validation: function (cell, value) {
	            ...
	            text: 'Type', dataField: '<?php echo $_smarty_tpl->tpl_vars['frefix']->value;?>
datatype', width: 80, sortable: true,
	            editable: false,
	            columntype: 'textbox', filtertype: 'textbox', filtercondition: 'CONTAINS'
	        },{
                text: 'Category', width: 120, cellsalign: 'left',
                columntype: 'dropdownlist',filtertype: 'list', filtercondition: 'EQUAL',
                datafield: '<?php echo $_smarty_tpl->tpl_vars['catfrefix']->value;?>
title', //displayfield:'<?php echo $_smarty_tpl->tpl_vars['catfrefix']->value;?>
title',
                editable: false,
...
status: 'false'}, entryId, me.onRefresh);
		...
		$(me.jqxgrid).jqxGrid({
			...
			virtualmode 		: true,
	        groupable 		    : true,
	        groups              : ['<?php echo $_smarty_tpl->tpl_vars['catfrefix']->value;?>
title'],
...
'
                ...
                'callback'    :   function(rsdata){
                    if(rsdata.result<0){
                        ...
                        var datatype = $('#entryForm input[name="<?php echo $_smarty_tpl->tpl_vars['frefix']->value;?>
datatype"]').val();
                        if($('#<?php echo $_smarty_tpl->tpl_vars['frefix']->value;?>
content').length==1 && datatype=='html'){
                            addEditorBasic('<?php echo $_smarty_tpl->tpl_vars['frefix']->value;?>
content',240);
                        }
...
content').length==1 && datatype=='html'){
    		$('#<?php echo $_smarty_tpl->tpl_vars['frefix']->value;?>
content').val(CKEDITOR.instances['<?php echo $_smarty_tpl->tpl_vars['frefix']->value;?>
content'].getData());
    	}
