...
class item extends CP_Controller {
    ...
    function viewport($unit='00000',$type=''){
        ...
        $this->smarty->view( 'dashboard/spin/item/viewport', $this->assigns );
    }
    function editpanel($type=''){
        ...
        switch ($layout){
            case '1':
                $htmlreponse = $this->smarty->view( 'dashboard/spin/item/editPanel', $this->assigns, true );
                break;
            default :
                $htmlreponse = $this->smarty->view( 'dashboard/spin/item/editPanel', $this->assigns, true );
        }
    ...
    function loadscript($src='',$unit='00000'){
        ...
        $this->smarty->view( 'dashboard/spin/item/'.$src, $this->assigns );
